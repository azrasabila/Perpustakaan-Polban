...
public class 98 {
  ...
  public void test98() throws Exception {
    ...
    driver.findElement(By.id("majors")).sendKeys("Teknik Kimia D III Teknik Kimia");
    driver.findElement(By.id("loanDateFrom")).click();
    driver.findElement(By.id("loanDateFrom")).clear();
    driver.findElement(By.id("loanDateFrom")).sendKeys("12/03/2020");
    driver.findElement(By.id("loanDateTo")).click();
    driver.findElement(By.id("loanDateTo")).click();
    driver.findElement(By.id("loanDateTo")).clear();
    driver.findElement(By.id("loanDateTo")).sendKeys("15/03/2020");
